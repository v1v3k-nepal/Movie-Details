      ...
      >
        ...
        <View className="self-start mx-4 space-y-2 mt-6">
          ...
          <Text className="text-neutral-400 tracking-wide">
            Tony Stark, also known as Iron Man, is a fictional character in the
            Marvel Comics universe. Created by writer and editor Stan Lee,
            scripter Larry Lieber, and artists Don Heck and Jack Kirby, Tony
            Stark made his first appearance in "Tales of Suspense" #39 in 1963.
            Name: Anthony Edward Stark Alter Ego: Iron Man Occupation: Inventor,
            Industrialist, Genius, Philanthropist, Superhero First Appearance:
            Tales of Suspense #39 (March 1963) Background: Tony Stark is
            portrayed as a wealthy and brilliant industrialist. He inherited
            Stark Industries, a multinational industrial company, from his
            father, Howard Stark. Tony is known for his genius-level intellect
            and his skills as an inventor and engineer.
          </Text>
        </View>
      </View>
      <View className="mt-6">
